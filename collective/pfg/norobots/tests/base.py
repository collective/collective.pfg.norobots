...
def setup_product():
    ...
    # Load the ZCML configuration for the collective.pfg.norobots package.
    # This can of course use <include /> to include other packages.

    fiveconfigure.debug_mode = True
    import collective.pfg.norobots
    zcml.load_config('configure.zcml', collective.pfg.norobots)
    ...
    ztc.installPackage('collective.pfg.norobots')
...
setup_product()
ptc.setupPloneSite(products=['collective.pfg.norobots'])
